    ...
    public partial class PrivateMessageBuilder : NopEntityBuilder<PrivateMessage>
    {
        ...
        public override void MapEntity(CreateTableExpressionBuilder table)
        {
            table
                ...
                .WithColumn(nameof(PrivateMessage.FromCustomerId)).AsGuid().ForeignKey<Customer>().OnDelete(Rule.None)
                .WithColumn(nameof(PrivateMessage.ToCustomerId)).AsGuid().ForeignKey<Customer>().OnDelete(Rule.None);
        }
