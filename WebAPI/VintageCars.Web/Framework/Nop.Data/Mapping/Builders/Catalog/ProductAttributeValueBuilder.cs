    ...
    public partial class ProductAttributeValueBuilder : NopEntityBuilder<ProductAttributeValue>
    {
        ...
        public override void MapEntity(CreateTableExpressionBuilder table)
        {
            table
                ...
                .WithColumn(nameof(ProductAttributeValue.ProductAttributeMappingId)).AsGuid().ForeignKey<ProductAttributeMapping>()
                .WithColumn(nameof(ProductAttributeValue.PictureId)).AsGuid().Nullable().ForeignKey<Picture>();
        }
