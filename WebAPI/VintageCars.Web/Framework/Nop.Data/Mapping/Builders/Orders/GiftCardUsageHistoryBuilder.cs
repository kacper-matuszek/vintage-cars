...
namespace Nop.Data.Mapping.Builders.Orders
{
    ...
    public partial class GiftCardUsageHistoryBuilder : NopEntityBuilder<GiftCardUsageHistory>
    {
        ...
        {
            table
                .WithColumn(nameof(GiftCardUsageHistory.GiftCardId)).AsGuid().ForeignKey<GiftCard>()
                .WithColumn(nameof(GiftCardUsageHistory.UsedWithOrderId)).AsGuid().ForeignKey<Order>();
        }
