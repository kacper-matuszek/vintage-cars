...
namespace Nop.Service.Products
{
    public interface IManufacturerService
    {
        ...
        IList<Guid> GetAppliedManufacturerIds(Discount discount, Core.Domain.Customers.Customer customer);
        ...
        IPagedList<Manufacturer> GetManufacturersWithAppliedDiscount(Guid? discountId = null,
        ...
        /// <returns>Manufacturers</returns>
        List<Manufacturer> GetManufacturersByIds(Guid[] manufacturerIds);
        ...
        IPagedList<ProductManufacturer> GetProductManufacturersByManufacturerId(Guid manufacturerId,
        ...
        IList<ProductManufacturer> GetProductManufacturersByProductId(Guid productId, Guid userId,
            bool showHidden = false);
        ...
        ProductManufacturer GetProductManufacturerById(Guid productManufacturerId);
        ...
        IDictionary<Guid, Guid[]> GetProductManufacturerIds(Guid[] productIds);
        ...
        ProductManufacturer FindProductManufacturer(IList<ProductManufacturer> source, Guid productId, Guid manufacturerId);
        ...
        DiscountManufacturerMapping GetDiscountAppliedToManufacturer(Guid manufacturerId, Guid discountId);
