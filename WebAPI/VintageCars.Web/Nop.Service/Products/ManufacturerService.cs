...
namespace Nop.Service.Products
{
    public class ManufacturerService : IManufacturerService
    {
        ...
        public ManufacturerService(IRepository<Manufacturer> manufacturerRepository,
            ...
            IRepository<Core.Domain.Stores.Store> storeRepository,
        ...
        public virtual IPagedList<Manufacturer> GetManufacturersWithAppliedDiscount(Guid? discountId = null,
        ...
        /// <returns>Manufacturers</returns>
        public virtual List<Manufacturer> GetManufacturersByIds(Guid[] manufacturerIds)
        {
        ...
        public virtual IPagedList<ProductManufacturer> GetProductManufacturersByManufacturerId(Guid manufacturerId,
        ...
        public virtual IList<ProductManufacturer> GetProductManufacturersByProductId(Guid productId, Guid userId,
            bool showHidden = false)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(NopCatalogDefaults.ProductManufacturersAllByProductIdCacheKey, productId,
                showHidden, userId, _storeRepository.Table.FirstOrDefault());
        ...
        public virtual ProductManufacturer GetProductManufacturerById(Guid productManufacturerId)
        {
            if (productManufacturerId == default)
                return null;
        ...
        public virtual IDictionary<Guid, Guid[]> GetProductManufacturerIds(Guid[] productIds)
        {
        ...
        public virtual ProductManufacturer FindProductManufacturer(IList<ProductManufacturer> source, Guid productId, Guid manufacturerId)
        {
        ...
        public DiscountManufacturerMapping GetDiscountAppliedToManufacturer(Guid manufacturerId, Guid discountId)
        {
