...
namespace Nop.Service.Products
{
    public class ProductTagService : IProductTagService
    {
        ...
        public virtual void DeleteProductProductTagMapping(Guid productId, Guid productTagId)
        {
        ...
        public Dictionary<Guid, int> GetProductCount(Guid storeId, bool showHidden)
        {
        ...
        /// <param name="productId">Product identifier</param>
        /// <returns>Product tags</returns>
        public virtual IList<ProductTag> GetAllProductTagsByProductId(Guid productId)
        {
        ...
        public virtual ProductTag GetProductTagById(Guid productTagId)
        {
            if (productTagId == default)
                return null;
        ...
        /// <returns>Product tags</returns>
        public virtual IList<ProductTag> GetProductTagsByIds(Guid[] productTagIds)
        {
        ...
        public virtual bool ProductTagExists(Product product, Guid productTagId)
        {
            if (product == null)
        ...
        public virtual int GetProductCount(Guid productTagId, Guid storeId, bool showHidden = false)
        {
