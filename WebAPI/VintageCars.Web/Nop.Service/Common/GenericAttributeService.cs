...
namespace Nop.Service.Common
{
    ...
    public partial class GenericAttributeService : IGenericAttributeService
    {
        ...
        {
            return attributeId == Guid.Empty ? null : _genericAttributeRepository.GetById(attributeId);
        }
        ...
        public virtual void SaveAttribute<TPropType>(BaseEntity entity, string key, TPropType value, Guid storeId = default)
        {
            if (entity == null)
        ...
        public virtual TPropType GetAttribute<TPropType>(BaseEntity entity, string key, Guid storeId = default, TPropType defaultValue = default)
        {
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));
        ...
        /// <param name="defaultValue">Default value</param>
        /// <returns>Attribute</returns>
        public virtual TPropType GetAttribute<TEntity, TPropType>(Guid entityId, string key, Guid storeId = default, TPropType defaultValue = default)
