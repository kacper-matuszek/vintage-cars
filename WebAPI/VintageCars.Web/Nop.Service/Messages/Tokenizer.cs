...
namespace Nop.Service.Messages
{
    ...
    public partial class Tokenizer : ITokenizer
    {
        ...
        public string ReplaceTokens(string template, IEnumerable<Token> tokens, bool htmlEncode = false, bool stringWithQuotes = false)
        {
        ...
        public string ReplaceConditionalStatements(string template, IEnumerable<Token> tokens)
        {
            //define regex rules
