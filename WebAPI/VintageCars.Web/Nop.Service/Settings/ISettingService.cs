...
namespace Nop.Service.Settings
{
    ...
    public partial interface ISettingService
    {
        ...
        /// <returns>Setting</returns>
        Setting GetSetting(string key, Guid storeId = default, bool loadSharedValueIfNotFound = false);
        ...
        T GetSettingByKey<T>(string key, T defaultValue = default,
            Guid storeId = default, bool loadSharedValueIfNotFound = false);
        ...
        void SetSetting<T>(string key, T value, Guid storeId = default, bool clearCache = true);
        ...
        bool SettingExists<T, TPropType>(T settings,
            Expression<Func<T, TPropType>> keySelector, Guid storeId = default)
        ...
        T LoadSetting<T>(Guid storeId = default) where T : ISettings, new();
        ...
        /// <param name="storeId">Store identifier for which settings should be loaded</param>
        ISettings LoadSetting(Type type, Guid storeId = default);
        ...
        void SaveSetting<T>(T settings, Guid storeId = default) where T : ISettings, new();
        ...
        void SaveSetting<T, TPropType>(T settings,
            ...
            Guid storeId = default, bool clearCache = true) where T : ISettings, new();
        ...
        void SaveSettingOverridablePerStore<T, TPropType>(T settings,
            Expression<Func<T, TPropType>> keySelector,
            bool overrideForStore, Guid storeId = default, bool clearCache = true) where T : ISettings, new();
        ...
        void DeleteSetting<T, TPropType>(T settings,
            Expression<Func<T, TPropType>> keySelector, Guid storeId = default) where T : ISettings, new();
