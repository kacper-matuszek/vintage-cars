...
import CategoryShortInfoView from "../../admin/categories/models/CategoryShortInfoView";
import CategoryAttributeFullInfoView from "../../admin/categories/models/CategoryAttributeFullInfoView";
